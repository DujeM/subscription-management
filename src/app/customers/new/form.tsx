...
export default function Form({selectSubscriptions}) {
    ...
    return (
        <form className="space-y-4 md:space-y-6" action={createCustomerAction}>
            ...
            <div>
                <Multiselect options={selectSubscriptions} label={'Subscriptions'} defaultValue={''} placeholder={'Assign subscriptions'} toggle={true} toggleLabel="Enable subscriptions?" toggleValue={false}/>
            </div>
